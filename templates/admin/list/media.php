...
echo '<a href="' . $name . '/add' . '" class="btn">' . 'Добавить' . '</a>';
...
if ( $list )
{
	foreach ($list as $key => $item) :
		...
		?><div class="p-25" style="max-width: 200px;"><div id="<?php echo $key; ?>" class="margin-0 padding-0 shadow-0">
			...
			<div class="over-h b margin-v-0" style="height: 1.15em;"><?php echo $item['title']; ?></div>

			<div class="over-h i margin-v-0" style="height: 1.15em;"><?php echo !empty($item['parent']) ? get_post($item['parent'],'title') : null; ?></div>
